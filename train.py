...
import model
import preprocessing_classification_for_single

epoches = 250
lr = 1
TRAIN_PATH = "./data/trainDataset.xls"
# load data
x_train_norm, x_test, y_train, y_test = preprocessing_classification_for_single.data_preprocessing(TRAIN_PATH)

train_dataset = Data.TensorDataset(x_train_norm, y_train)
